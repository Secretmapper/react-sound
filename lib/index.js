...
var _soundmanager2ScriptSoundmanager2NodebugJsminJs = require('soundmanager2/script/soundmanager2-nodebug-jsmin.js');

var pendingCalls = [];
var initialized = false;

function _createSound(options, cb) {
  if (_soundmanager2ScriptSoundmanager2NodebugJsminJs.soundManager.ok()) {
    cb(_soundmanager2ScriptSoundmanager2NodebugJsminJs.soundManager.createSound(options));
    return function () {};
  } else {
    var _ret = (function () {
      if (!initialized) {
        initialized = true;
        _soundmanager2ScriptSoundmanager2NodebugJsminJs.soundManager.beginDelayedInit();
      }
...
_soundmanager2ScriptSoundmanager2NodebugJsminJs.soundManager.onready(function () {
...
var Sound = (function (_React$Component) {
  ...
  _createClass(Sound, [{
    ...
    value: function createSound(callback) {
      ...
      this.stopCreatingSound = _createSound(_extends({}, this.props.options, {
        url: this.props.url,
        volume: props.volume,
